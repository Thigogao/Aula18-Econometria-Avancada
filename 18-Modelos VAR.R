...
colnames(br) <-  c("PIB","Emprego","Câmbio")   #Renomeia as colunas para PIB, Trabalho e CÃ¢mbio
BR <- br[45:62,1:3]
...
lst = list(h1,h2,h3)
hw_grid(lst, ncol = 2, rowheight = 400)  %>% browsable()  #Todos Trás Gráficos Juntos
